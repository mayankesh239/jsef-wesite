...
const testimonials = [
    ...
    {
        // href: "/",
        content: 'PENolution: "The pen is mightier than the sword."',
        name:
            'Revolutions and radical ideas are best conveyed via simple words understood en masse. Not everyone writes words that sway people and win them over; only a certain few have the skill to do so. In “PENolution” (a concatenation of pen and revolution), the participants\' grasp on environmental issues and eco-friendly practices are tested in the form of an essay where their eloquence and their hand on language will be deciding factor. The topic of the essay will be shared the day before the event.           ',
        avatar:
...
export default function GridBlurredBackdrop() {
    return (
        <Flex
            ...
            <Box>
                <Icon viewBox="0 0 40 35" mt={14} boxSize={20} color={'purple.400'}>
                    <path
                        fill={'currentColor'}
